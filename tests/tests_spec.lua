...
describe("g0.test", function()
  ...
  it("successfully runs TestCurrent", function()
    ...
    assert.spy(vim.fn.jobstart).was_called(1)
    assert.spy(vim.fn.jobstart).was_called_with("go test ./" .. tempFolderPath .. "/... -run=TestAdd", match.is_table())
  end)
  ...
  it("successfully runs TestCurrent with verbose flag", function()
    ...
    assert.spy(vim.fn.jobstart).was_called(1)
    assert.spy(vim.fn.jobstart).was_called_with("go test ./" .. tempFolderPath .. "/... -run=TestAdd -v", match.is_table())
  end)
  ...
  it("successfully runs TestCurrentDir", function()
    ...
    assert.spy(vim.fn.jobstart).was_called(1)
    assert.spy(vim.fn.jobstart).was_called_with("go test ./" .. tempFolderPath .. "/...", match.is_table())
  end)
  ...
  it("successfully runs TestCurrentDir with verbose flag", function()
    ...
    assert.spy(vim.fn.jobstart).was_called(1)
    assert.spy(vim.fn.jobstart).was_called_with("go test ./" .. tempFolderPath .. "/... -v", match.is_table())
  end)
